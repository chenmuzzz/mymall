...
.explode {
  background:url(/mymall/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/mymall/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/mymall/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/mymall/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
        ...
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    ...
                    <li class="menu-item"><a href="<?php echo U('goods/goodsTrash');?>" target="main-frame">商品回收站</a></li>
                </ul>
            </li>
...
<script type="text/javascript" src="/mymall/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/mymall/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/mymall/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/mymall/Public/Admin/Images/menu_minus.gif' : '/mymall/Public/Admin/Images/menu_plus.gif';
